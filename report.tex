...
\title{Exploration of adaptation of XAI methods for Automatic Speech Recognition}
...
\thanks{$^{\dagger}$Supervised by Prof. Dr. Sebastian Houben (Hochschule Bonn-Rhein-Sieg) and Roman Bartolosch, M.Sc. (FKIE)}
...
{Arunima Chaurasia: Exploration of adaptation of XAI methods for Automatic Speech Recognition}
...
\begin{IEEEkeywords}
Explainable AI, Automatic Speech Recognition, Transformer-based models.
\end{IEEEkeywords}
